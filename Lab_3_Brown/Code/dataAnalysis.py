...
tif_file = "Lab_3_Brown/Data/Day 2 Trial 4 - 1 micron - 10x magnification/image_1.tif"
background = (
    "Lab_3_Brown/Data/Day 2 Trial 4 - 1 micron - 10x magnification/background.tif"
)
ruler = "Lab_3_Brown/Data/Day 2 Trial 4 - 1 micron - 10x magnification/ruler.tif"
...
for j in range(1):
    ...
    print("len = ", len(centered_displacements[0]))
    e_x2 = []
...
print(tif_file, "k_b", slope * 6 * np.pi * 0.0008538 * 0.0000010 / (4 * 300))
print(
    tif_file,
    "k_b error",
    np.linalg.norm(a_errs)
    / np.sqrt(len(a_errs))
    * 6
    * np.pi
    * 0.0008538
